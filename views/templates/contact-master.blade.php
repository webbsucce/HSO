...
<div id="wrapper">
    ...
    @yield('scroll-btn')
    <main id="main-content" class="clearfix no-padding-top">
        <div class="contact-page">
            @yield('content')
        </div>
        @yield('whatsup-section')
    </main>

    <div class="contact-page">
        @yield('google-map-section')
    </div>
    ...
    <main id="main-content" class="clearfix no-padding-top">
        @if (is_active_sidebar('content-area-bottom'))
            <div class="contact-page">
                <div class="container gutter-xl gutter-vertical sidebar-main-content-area-bottom">
                    <div class="grid">
